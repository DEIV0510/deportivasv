/* TiendaDeportivaSV — equipos disponibles bajo pedido.
   ...
   Cada equipo: { n: nombre, s: iniciales, c: [color1, color2, color3] }
   Los colores son los tradicionales del equipo y forman la franja
   superior de la tarjeta (no se usan escudos ni logos de terceros).
   ------------------------------------------------------------------ */
window.SV_EQUIPOS = {

  selecciones: [
    { n: 'Argentina',  s: 'ARG', c: ['#75AADB', '#ffffff', '#75AADB'] },
    { n: 'Brasil',     s: 'BRA', c: ['#FFDF00', '#009C3B', '#002776'] },
    { n: 'Colombia',   s: 'COL', c: ['#FCD116', '#003893', '#CE1126'] },
  ...
  clubes: [
    ...
    { n: 'Chelsea',            s: 'CHE', c: ['#034694', '#ffffff', '#DBA111'] },
    ...
    { n: 'Santos',             s: 'SAN', c: ['#ffffff', '#000000', '#ffffff'] }
  ],

  colombia: [
    { n: 'Atlético Nacional',        s: 'NAL', c: ['#007A33', '#ffffff', '#007A33'] },
    { n: 'Millonarios',              s: 'MFC', c: ['#003DA5', '#ffffff', '#003DA5'] },
    { n: 'América de Cali',          s: 'AME', c: ['#E30613', '#ffffff', '#E30613'] },
    { n: 'Junior',                   s: 'JUN', c: ['#E30613', '#ffffff', '#003DA5'] },
    { n: 'Deportivo Cali',           s: 'CAL', c: ['#009B3A', '#ffffff', '#009B3A'] },
    { n: 'Independiente Medellín',   s: 'DIM', c: ['#E30613', '#003DA5', '#E30613'] },
    { n: 'Once Caldas',              s: 'OCA', c: ['#ffffff', '#E30613', '#ffffff'] },
    { n: 'Deportes Tolima',          s: 'TOL', c: ['#C8102E', '#FFD100', '#C8102E'] }
  ]
};
